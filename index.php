...
<body>
    ...
    <div class="container-fluid pt-3"><a href="getmytask.php"><br>View only my tasks</button></a>
...
<div class="container-fluid pt-3"><br><br>
        ...
        <div section="wrapper">
        <!-- Drag and drop between various status and update status -->
        </div>
        <div class="row flex-row flex-sm-nowrap py-3" >
                        ...
                        <?php
                            ...
                            <div class="card draggable shadow-sm" id="drag-<?php echo $todo_row['task_id']?>"  draggable="true" ondragstart="drag(event)">
                                <div class="card-body p-2">
                                    ...
                                    <p>Assignee : <?php echo $todo_row['task_assignee'] ?> </p>
                        ...
                        <?php
                            ...
                            <div class="card draggable shadow-sm" id="cd1" draggable="true" ondragstart="drag(event)">
                                <div class="card-body p-2">
                                    ...
                                    <p>Assignee : <?php echo $inprogress_row['task_assignee'] ?> </p>
                        ...
                        <?php
                            ...
                            <div class="card draggable shadow-sm" id="cd9" draggable="true" ondragstart="drag(event)">
                                <div class="card-body p-2">
                                    ...
                                    <p>Assignee : <?php echo $review_row['task_assignee'] ?> </p>
            ...
            <div class="col-sm-6 col-md-4 col-xl-3 hello bg-success">
                <div class="card">
                    <div class="card-body">
                        <h6 class="card-title text-uppercase text-truncate py-2">DONE   - [ <?php echo mysqli_fetch_array($complete_count_result)['complete_count'] ?> ]</h6>
                        <div class="items border border-light">
                        <?php
                            ...
                            <div class="card draggable shadow-sm" id="cd11" draggable="true" ondragstart="drag(event)">
                                <div class="card-body p-2">
                                    ...
                                    <p>Assignee : <?php echo $complete_row['task_assignee'] ?> </p>
